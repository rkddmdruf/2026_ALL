...
namespace _1_6_test_4 {
    ...
    public partial class Moment : UserControl {
        ...
        public Moment() {
            ...
            for(int i = 1; i <= 42; i++) {
                ...
                l.Paint += (sender, e) => {
                    ...
                    if (
                        !sp.selectTime.Date.Equals(new DateTime(1119,11,19).Date) && 
                        sp.selectTime.Month.Equals(date.Month) && 
                        sp.selectTime.Day.ToString().Equals(l.Text)
                    ) {
        ...
        private void label46_Click(object sender, EventArgs e) {
            if(sp.selectTime == null || sp.selectTime.Date.Equals(new DateTime(1119, 11, 19))) {
        ...
        private void Moment_VisibleChanged(object sender, EventArgs e) {
            if(Visible) { sp.selectTime = new DateTime(1119, 11, 19); textBox1.Text = ""; comboBox1.Items.Clear(); }
        }
    }
}
