...
namespace _1_5_test_3 {
    public partial class ReservationForm : Form {
        ...
        public ReservationForm(int hno) {
            ...
            pictureBox1.Image = Properties.Resources.ResourceManager.GetObject("_" + hotel.hno) as Image;
            addressLabel.Text = "지역 : " + hotel.address.aName;
            gradeLabel.Text = "등급 : " + hotel.ratno + "성급(" + new string('★', hotel.ratno.Value) + ")";
            textBox1.Text = hotel.explanation;
        ...
        private void settingReview() {
            ...
            foreach (var re in sp.entity.review.ToList().Where(t => t.reservation.hno == hotel.hno)) {
                Label label = new Label() {
                    Text = new string('★', re.score == null ? 0 : re.score.Value),
