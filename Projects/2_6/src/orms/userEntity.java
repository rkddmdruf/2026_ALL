...
public class userEntity {
	...
	public void save() {
		String sql = (uno == null) ? "insert into user (name,id,pw,card,birth,price) values (?,?,?,?,?,?)"
				: "update user set name = ?,id = ?,pw = ?,card = ?,birth = ?,price = ? where uno = ?";
		Object[] values = (uno == null) ? new Object[] { name, id, pw, card, birth, price }
				: new Object[] { name, id, pw, card, birth, price, uno };
