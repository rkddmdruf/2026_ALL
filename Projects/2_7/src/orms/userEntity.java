...
e.lno= rs.getInt("lno");
	...
	public void save() {
		String sql = (uno == null)
				? "insert into user (name,id,pw,card,lno) values (?,?,?,?,?)"
				: "update user set name = ?,id = ?,pw = ?,card = ?,lno = ? where uno = ?";
		Object[] values = (uno == null)
			? new Object[] {name,id,pw,card,lno}
			: new Object[] {name,id,pw,card,lno, uno};
