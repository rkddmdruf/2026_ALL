...
public class rewardEntity {
	...
	public static void reload() {
		cache.clear();
		try (var stmt = DBManager.execute("SELECT * from reward"); var rs = stmt.executeQuery()) {
			while (rs.next()) {
	...
	public String toString() {
		return "rewardEntity [reno=" + reno + ", resale=" + resale + "]";
	}
	...
	public void save() {
		String sql = (reno == null) ? "insert into reward (resale) values (?)"
				: "update reward set resale = ? where reno = ?";
		Object[] values = (reno == null) ? new Object[] { resale } : new Object[] { resale, reno };
