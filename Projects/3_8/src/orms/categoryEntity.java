...
public class categoryEntity {
	...
	public static void reload() {
		cache.clear();
		try (var stmt = DBManager.execute("SELECT * from category"); var rs = stmt.executeQuery()) {
			while (rs.next()) {
	...
	public void save() {
		String sql = (cno == null) ? "insert into category (cname) values (?)"
				: "update category set cname = ? where cno = ?";
		Object[] values = (cno == null) ? new Object[] { cname } : new Object[] { cname, cno };
