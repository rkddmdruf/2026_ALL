...
public Integer s_y;
    ...
    public static void reload() {
        cache.clear();
        try (var stmt = DBManager.execute("SELECT * FROM store");
...
e.s_y= rs.getInt("s_y");
    ...
    public storeEntity(Integer s_no,String s_name,String s_id,String s_pw,Integer l_no,Integer c_no,String s_info,Integer s_x,Integer s_y) {
        this.s_no = s_no;
this.s_name = s_name;
this.s_id = s_id;
this.s_pw = s_pw;
...
this.s_y = s_y;
    ...
    public void save() {
        ...
        Object[] values = (s_no == null)
                ? new Object[]{s_name,s_id,s_pw,l_no,c_no,s_info,s_x,s_y}
